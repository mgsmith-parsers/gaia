...
1. **जोडणी** — AI/मूल्य जोड्या जोडून एक संभाव्य घटक स्ट्रिंग तयार होते. ज्या प्रत्येक AI ला *विभाजक लागतो* आणि जो शेवटचा घटक नाही, त्याच्यानंतर FNC1 गट-विभाजक (`0x1D`) घातला जातो. ज्यांची लांबी आधीच ठरलेली आहे असे AI (GTIN, दिनांक, निश्चित-लांबीची मापे) विभाजक घेत नाहीत; बाकीचे घेतात. (अनोळखी AI या पायरीपर्यंत पोहोचतच नाहीत — `ai(...)` त्यांना तत्काळ नाकारतो; पाहा [घटक स्ट्रिंग तयार करणे](#घटक-सटरग-तयर-करण).)
2. **पडताळणी** — संभाव्य स्ट्रिंग `GaiaParser` कडून `CONTENT` पद्धतीत पार्स केली जाते. प्रत्येक मूल्य त्याच्या AI च्या स्वरूपाशी आणि तपासणी अंकाशी तपासले जाते, आणि संरचनात्मक नियम (आवश्यक व वर्जित AI जोड्या) लागू केले जातात. पार्सिंग वैध नसेल, तर बांधणी अपयशी ठरते.
3. **सादरीकरण** —
...
`calculateCheckDigit(String)` दिलेल्या अंकांवर GS1 चा प्रमाण मोड्युलो-10 अल्गोरिदम लावते आणि `0` ते `9` यांतील तपासणी अंक परत करते, किंवा इनपुट `null`, रिकामे किंवा असंख्यात्मक असल्यास `-1`.
