...
/** Tests for {@link Iso4217Validator} — component format {@code iso4217}. */
@DisplayName("Iso4217Validator (iso4217)")
class Iso4217ValidatorTest {

    private final ComponentFormatInterface validator = FormatValidators.forFormat("iso4217");

    @Test
    @DisplayName("is registered for format 'iso4217'")
    void registeredForFormat() {
        assertNotNull(validator, "FormatValidators must know format 'iso4217'");
        assertTrue(validator instanceof Iso4217Validator, "format 'iso4217' must map to Iso4217Validator");
    }
