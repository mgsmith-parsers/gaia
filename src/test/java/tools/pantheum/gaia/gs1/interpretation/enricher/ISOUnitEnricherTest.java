...
/** Tests for {@link ISOUnitEnricher} — interpretation enrichment for AI (3100). */
@DisplayName("ISOUnitEnricher (AI 3100)")
class ISOUnitEnricherTest {
    ...
    void resolvableFromRegistry() {
        assertTrue(InterpretationRegistry.INSTANCE.enricherFor("ISOUnitEnricher").isPresent(),
                "ISOUnitEnricher must be resolvable by simple class name");
    }
