...
/** Tests for {@link Iso4217Enricher} — interpretation enrichment for AI (3910). */
@DisplayName("Iso4217Enricher (AI 3910)")
class Iso4217EnricherTest {
    ...
    void resolvableFromRegistry() {
        assertTrue(InterpretationRegistry.INSTANCE.enricherFor("Iso4217Enricher").isPresent(),
                "Iso4217Enricher must be resolvable by simple class name");
    }
