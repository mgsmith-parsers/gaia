...
/** Tests for {@link TimeEnricher} — interpretation enrichment for AI (4324). */
@DisplayName("TimeEnricher (AI 4324)")
class TimeEnricherTest {
    ...
    void resolvableFromRegistry() {
        assertTrue(InterpretationRegistry.INSTANCE.enricherFor("TimeEnricher").isPresent(),
                "TimeEnricher must be resolvable by simple class name");
    }
